...
const Body = () => {
  ...
  const slides = [
    { image: "/logo.png", title: "Classroom Attendance" },
    { image: "/vjit-pica.png", title: "Digital Dashboard Analytics" },
    {
      image:
  ...
  const features = [
    {
      ...
      description:
        "Advanced barcode scanning technology for instant student identification and attendance tracking in real-time",
      icon: FaQrcode
    },
    {
      title: "Enhanced Security",
      description:
        "End-to-end encryption and secure authentication ensuring student data privacy and system integrity",
      icon: FaShieldAlt
    },
    {
      title: "Advanced Analytics",
      description:
        "Comprehensive dashboards with detailed insights, trends, and patterns in attendance data",
      icon: FaChartLine
    },
    {
      title: "Instant Notifications",
      description:
        "Real-time alerts for absent students, late arrivals, and important attendance updates",
      icon: FaBell
    },
    {
      title: "User Management",
      description:
        "Flexible roles and permissions system for administrators, teachers, and staff members",
      icon: FaUsersCog
    },
    {
      title: "Downloadable Reports",
      description:
        "Export attendance data in various formats, PDF, and Excel for easy sharing and analysis",
      icon: FaFileDownload
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0F] overflow-x-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-5xl md:text-7xl font-bold">
                <span className="text-white">Manage Late Comers</span>
                <span className="block bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">
                  Effortlessly
                </span>
              </h1>
              <p className="text-xl text-gray-300 max-w-lg">
                Create, track, and manage student attendance all in one
                place. The complete platform for educational institutions.
              </p>
      ...
      <div className="py-32 bg-[#0A0A0F] relative">
        ...
        >
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            className="max-w-3xl mx-auto space-y-6 text-gray-300 text-base md:text-lg backdrop-blur-lg bg-white/5 p-4 md:p-8 rounded-2xl"
          >
            ...
            <p>
              Attendo is a smart and secure latecomers management system designed
              to modernize attendance tracking in educational institutions. Our
              application enables institutions to monitor student punctuality
              through secure barcode scanning, geofencing-based verification, and
              real-time data analysis. By identifying latecomers automatically
              and generating insightful reports, Attendo helps faculty and
              administrators take timely actions and maintain discipline. With
              features such as instant notifications, performance dashboards,
              and reliable analytics, Attendo transforms traditional attendance
              into a data-driven tool for improving time management and
              accountability.
            </p>
          </motion.div>
        </motion.div>
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute inset-0 bg-[linear-gradient(to_right,transparent_0%,#1E3A8A_50%,transparent_100%)] opacity-5 animate-gradient-x" />
        <div className="absolute inset-0 bg-[linear-gradient(to_bottom,transparent_0%,#1E3A8A_50%,transparent_100%)] opacity-5 animate-gradient-y" />
      </div>
    </div>
  );
};
